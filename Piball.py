...
#Where Score is displayed
   # def Name():
       # Name = entry.get()#stores the first input as Name  
    ...
    def open_text():
       ...
       numbers = (readthefile)#sorting the numbers
       sorted(numbers, reverse = True)
       numbers = ("".join(numbers))#sorting the numbers
       print(numbers)
...
def selected(event):
    ...
    if clicked.get() == 'PAUSE':
        canvas.delete(xspeed)
        canvas.delete(yspeed)
